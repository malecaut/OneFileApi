        ...
        while data:
            for journalJson in data:
                ...
                for entry in self.entries:
                    ...
                    #if entry.timesheetId == str(journalJson['entryData']['trainingActivities'][0]):
                        counter = counter + 1
                        found = True
            ...
            #r = self.session.get("https://learning.onefile.co.uk/api/journalEntry",json=rParams)
